<<<<<<< HEAD:src/main/java/com/fit_track_api/fit_track_api/repository/CommentRepository.java
...
=======
=======
>>>>>>> origin/shakya:src/main/java/com/fitness_track_api/fitness_track/repository/CommentRepository.java
...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    List<Comment> findByAchievementId(Long achievementId);
}